...
function addData() {
    if (test == 1) {
        ...
        row.style.backgroundImage="radial-gradient( circle farthest-corner at 10% 20%,  rgba(137,247,254,1) 0%, rgba(102,166,255,1) 90% )";
        ...
        Student_CGPA.textContent = "Campus";
        ...
        newRow.style.backgroundImage="linear-gradient( 109.6deg,  rgba(112,246,255,0.33) 11.2%, rgba(221,108,241,0.26) 42%, rgba(229,106,253,0.71) 71.5%, rgba(123,183,253,1) 100.2% )";
        ...
        updatebuttton.style.marginLeft="-1.3%";
        updatebuttton.style.marginTop="-14%";
        updatebuttton.style.fontSize="24px";
        updatebuttton.style.fontWeight="900px";
        updatebuttton.style.backgroundImage= "linear-gradient( 90.3deg,  rgba(4,251,16,1) -0.3%, rgba(251,250,16,1) 64.3% )";
        ...
        updatebuttton.onclick = function() {
            ...
            var cgpa = prompt("Enter new CAMPUS:");
        ...
        deletebutton.style.marginLeft="-1.3%";
        deletebutton.style.marginTop="-14%";
